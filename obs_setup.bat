...
echo FFURL=udp://%IP_INPUT%:41263?pkt_size=1316
echo FFFormat=mpegts
echo FFFormatMimeType=video/MP2T
echo FFVEncoderId=27
echo FFVEncoder=libx264
echo FFAEncoderId=0
echo FFAEncoder=
...
echo RecAudioEncoder=ffmpeg_aac
echo RecSplitFileType=Time
echo FFURL=udp://%IP_INPUT%:41264?pkt_size=1316
echo FFFormat=mpegts
echo FFFormatMimeType=video/MP2T
echo FFVEncoderId=27
echo FFVEncoder=libx264
